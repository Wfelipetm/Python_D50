'''Neste último desafio, vamos adicionar mais uma funcionalidade para o nosso sistema da lancheria.
...
def ImprimePedidosDoDia():
    textoRelatorioPedidosDoDia = GeraCabecalhoRelatorio(
        "RELATORIO DE PEDIDOS DO DIA")
